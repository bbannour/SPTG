...
public:
	 ...
	 * CONSTANT
	 */
	static const std::size_t  mDefaultLineWrapWidth = 42;
...
public:
	 ...
	 * Default
	 */
	Serializer(SymbexControllerUnitManager & aManager,
	...
	bool filterExecutionConfiguration(
			const TraceFilter & mTraceFilter,
...
public:
	 ...
	 * Default
	 */
	AutoRegisteredSerializerProcessorUnit(
