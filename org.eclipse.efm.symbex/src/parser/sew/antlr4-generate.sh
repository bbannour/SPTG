...
#########################################
# FML a.k.a. Formal Modeling Language grammar
#########################################
#
CLASSPATH=../../../third-party/antlr/antlr-4.11.1-complete.jar

java -cp $CLASSPATH org.antlr.v4.Tool -Dlanguage=Cpp -no-listener -no-visitor -o ./ -package sep  SEWLexer.g4 SEWParser.g4
