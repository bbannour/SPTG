...
protected:
	...
	const AvmTransition * mTransitionTarget;
...
public:
	...
	bool initialize(ExecutionContext * aDirectiveEC,
			const AvmTransition * aTransitionTarget);
