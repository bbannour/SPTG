...
#include <base/StaticNullReference.h>
...
/**
 * Macro for adding default Static Null Reference
 */
#define AVM_INJECT_STATIC_NULL_REFERENCE( ClassName )  \
		public StaticNullReference< ClassName >
