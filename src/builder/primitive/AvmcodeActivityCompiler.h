...
AVMCODE_COMPILER_EXPRESSION_OPTIMIZER_CLASS("SELF_SUPER",
		SelfSuperStatement, AvmcodeActivityStatementCompiler)

AVMCODE_COMPILER_STATEMENT_OPTIMIZER_CLASS("CONTEXT_SWITCHER",
		ContextSwitcherStatement, AvmcodeActivityStatementCompiler)


AVMCODE_COMPILER_STATEMENT_OPTIMIZER_CLASS("PROCESS#STATE#SET",
		ProcessStateSet, AvmcodeActivityStatementCompiler)
