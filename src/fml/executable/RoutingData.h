...
class RoutingDataElement final : public Element ,
...
class RoutingData final :
		public SmartPointer< RoutingDataElement , DestroyElementPolicy >,
		AVM_INJECT_STATIC_NULL_REFERENCE( RoutingData ),
...
public:
	 ...
	 */
	inline static RoutingData & nullref()
	{
