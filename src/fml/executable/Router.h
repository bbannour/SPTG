...
class RouterElement final : public Element ,
...
public:
	...
	{
		mInputRoutingTable.clear();
		mOutputRoutingTable.clear();
	}
...
public:
	...
	void disposeRoutingData()
	{
		base_this_type::mPTR->disposeRoutingData();
	}
