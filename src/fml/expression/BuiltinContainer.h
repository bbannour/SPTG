...
public:
	...
	inline virtual bool full() const final
	{
...
public:
	 ...
	 * mCapacity
	 */
	inline virtual std::size_t capacity() const override final
	{
		return( mCapacity );
	}
...
public:
	...
	inline virtual std::size_t size() const override final
	{
		return( mData.size() );
	}
	...
	inline virtual bool contains(const BF & arg) const override final
	{
...
public:
	...
	inline virtual BF & first() override final
	{
		return( mData.first() );
	}
	...
	inline virtual BF & last() override final
	{
		return( mData.last() );
	}
	...
	inline virtual void remove(const BF & arg) override final
	{
		mData.remove(arg);
	}
...
class BuiltinReverseVector final :  public BuiltinVector ,
...
class BuiltinSet final :  public BuiltinList ,
...
class BuiltinBag final :  public BuiltinList ,
