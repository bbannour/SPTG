...
public:
	...
	inline virtual bool isEQ(const Element & anElement) const final
	{
	...
	inline virtual bool isNEQ(const Element & anElement) const final
	{
		return( this != (& anElement) );
	}
	...
	virtual bool isTEQ(const Element & anElement) const final
	{
		return( this == (& anElement) );
	}
	...
	inline virtual bool isNTEQ(const Element & anElement) const final
	{
		return( this != (& anElement) );
	}
...
//		AVM_OS_WARN << "destroy< @ " << std::intptr_t( this )
		...
		AVM_OS_COUT << "destroy< @ " << std::intptr_t( this )
