...
#include "GraphicExecutionGraphSerializer.h"
...
/*******************************************************************************
serializer += GraphicExecutionGraphSerializer <name-id> "<description>" {
	// ...
...
/**
prototype processor::serializer#graph "serialize graph" as GraphicExecutionGraphSerializer is
section PROPERTY
...
bool GraphicExecutionGraphSerializer::configureImpl()
{
...
bool GraphicExecutionGraphSerializer::configureFormatter(const WObject * FORMAT,
 ...
 * REPORT TRACE
 */
void GraphicExecutionGraphSerializer::reportDefault(OutStream & out) const
{
 ...
 * FILTERING API
 */
bool GraphicExecutionGraphSerializer::prefilter()
{
	return( true );
}

bool GraphicExecutionGraphSerializer::postfilter()
{
	return( true );
}
 ...
 * POST-PROCESSING API
 */
bool GraphicExecutionGraphSerializer::postprocess()
{
...
bool GraphicExecutionGraphSerializer::configureDefaultImpl(
...
//
//	AVM_OS_TRACE << "GraphicExecutionGraphSerializer->TraceFilter:> ";
...
void GraphicExecutionGraphSerializer::format(
		...
		bool showTransition, bool showCommunication, bool showAssign)
{
	AbstractProcessorUnit * existingSerializer =
			aManager.getControllerUnit(
					GraphicExecutionGraphSerializer::AUTO_REGISTER_TOOL);

	if( existingSerializer != nullptr )
	{
		GraphicExecutionGraphSerializer gvSerializer(
	...
	{
		GraphicExecutionGraphSerializer gvSerializer(aManager, WObject::_NULL_);
...
void GraphicExecutionGraphSerializer::dotFormat(
		OutStream & out, const ListOfExecutionContext & rootECs)
{
 ...
 * %1% --> graph name-id
 */
void GraphicExecutionGraphSerializer::doFormatHeader(OutStream & out)
{
 ...
 * %1% --> graph name#id
 */
void GraphicExecutionGraphSerializer::doFormatEnd(OutStream & out)
{
 ...
 * %8% --> node#flags
 */
void GraphicExecutionGraphSerializer::dotFormatNode(
...
std::string GraphicExecutionGraphSerializer::dotNodeColor(
...
std::string GraphicExecutionGraphSerializer::dotNodeShape(
		const ExecutionContext & anEC)
{
	const ExecutionContextFlags & flags = anEC.getFlags();
...
std::string GraphicExecutionGraphSerializer::dotNodeStyle(
		const ExecutionContext & anEC)
{
	const ExecutionContextFlags & flags = anEC.getFlags();
 ...
 * %6% --> node#target#trace
 */
void GraphicExecutionGraphSerializer::dotFormatInfo(
...
void GraphicExecutionGraphSerializer::dotFormatEdge(OutStream & out,
 ...
 * %6% --> statemachine configuration i.e. lifelines state identifier
 */
void GraphicExecutionGraphSerializer::dotFormatNodeHeader(
		OutStream & out, const ExecutionContext & anEC)
{
 ...
 * %7% --> ec#node#buffer
 */
void GraphicExecutionGraphSerializer::dotFormatNodeData(
		OutStream & out, const ExecutionContext & anEC)
{
 ...
 * %2% --> execution info
 */
void GraphicExecutionGraphSerializer::dotFormatNodeInfo(
		OutStream & out, const ExecutionContext & anEC)
{
	if( anEC.hasInfo() )
	{
 ...
 * %2% --> execution fired
 */
void GraphicExecutionGraphSerializer::dotFormatNodeRunnableTrace(
		OutStream & out, const ExecutionContext & anEC)
{
 ...
 * invoked routine
 */
void GraphicExecutionGraphSerializer::dotFormatRunnableTrace(
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatMachine(
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatTransition(OutStream & out,
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatRoutine(OutStream & out,
 ...
 * %2% --> execution trace
 */
void GraphicExecutionGraphSerializer::dotFormatNodeIOTrace(
		OutStream & out, const ExecutionContext & anEC)
{
	StringOutStream ecTrace( out );
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatIOTrace(
 ...
 * %7% --> message $timestamp
 */
void GraphicExecutionGraphSerializer::dotFormatInputOutput(OutStream & out,
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatAssignBuffer(
 ...
 * %4% --> value
 */
void GraphicExecutionGraphSerializer::dotFormatAssignBuffer(OutStream & out,
 ...
 * %4% --> value
 */
void GraphicExecutionGraphSerializer::dotFormatNewfresh(
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatCondition(OutStream & out,
 ...
 */
void GraphicExecutionGraphSerializer::dotFormatAssignVariable(
		OutStream & out, const ExecutionContext & anEC, bool isnotRoot)
{
	const ExecutionData & anED = anEC.getExecutionData();
	const ExecutionData & prevED = ( isnotRoot ?
 ...
 * %4% --> value
 */
void GraphicExecutionGraphSerializer::dotFormatAssignVariable(OutStream & out,
