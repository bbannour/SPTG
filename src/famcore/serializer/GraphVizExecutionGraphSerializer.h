...
#ifndef FAM_SERIALIZER_GRAPHVIZ_EXECUTION_GRAPHSER_H_
#define FAM_SERIALIZER_GRAPHVIZ_EXECUTION_GRAPHSER_H_
...
class GraphVizExecutionGraphSerializer final :
...
#endif /* FAM_SERIALIZER_GRAPHVIZ_EXECUTION_GRAPHSER_H_ */
