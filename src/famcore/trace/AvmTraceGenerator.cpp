...
bool AvmTraceGenerator::configureImpl()
{
	...
	if ( mTraceTypeID.starts_with("SEQUENCE_DIAGRAM") )
	{
	...
	if( mTraceTypeID.starts_with("TTCN") )
	{
//		if( mTraceTypeID.starts_with("TTCN#TITAN") )
	...
	else if( mTraceTypeID.starts_with("BASIC") )
	{
		mTraceFormatter = new BasicTraceFormatter( *this );
	}
	else if( mTraceTypeID.starts_with("SEQUENCE_DIAGRAM") )
	{
