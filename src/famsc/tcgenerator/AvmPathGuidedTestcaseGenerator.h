...
class AvmPathGuidedTestcaseGenerator final :
		public AutoRegisteredCoverageProcessorUnit< AvmPathGuidedTestcaseGenerator >
{
	...
	AVM_INJECT_AUTO_REGISTER_QUALIFIED_ID_KEY_3(
			"path#guided#testcase#generator",
...
public:
	...
	std::string mVarNameClock;
	std::string mVarNameTimeout;
	std::string mVarPrefixNameOutputArg;
	bool mEnableGuardSimplification;
	bool mEnableGlobalVerdictState;
