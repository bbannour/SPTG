...
tcSystem( "Testcase_S", sutSystem.getSpecifier() ),
tcMachine( nullptr ),
tcQuiescencePort( )
//tcStateFAIL( nullptr ),
//tcStateINC( nullptr )
...
void AvmLabelledTestCaseFactory::buildStructure(const System & sutSystem, System & tcSystem)
{
	...
	tcMachine = Machine::newStatemachine(& tcSystem, "Testcase_SM",
...
{
	ExecutionContext::VectorOfConstPtr traceECs(testPurposeTrace);
