...
# Generic version for multiple instanciation based on testpurpose length
VERSION="_h2"

# The selected Symbolic Execution Workflow
SPTG_SEW=$SAMPLE_PATH/workflow_4_testpurpose_selection.sew

#  We assume that the SPTG_SEW is configured with these output parameters.
SPTG_OUT=$SAMPLE_PATH/output_testpurpose_selection
SPTG_OUT_PUML_MODEL=$SPTG_OUT/example05_automotive_platoon.puml
